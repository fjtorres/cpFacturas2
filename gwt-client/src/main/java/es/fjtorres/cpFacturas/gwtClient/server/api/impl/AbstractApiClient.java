...
public abstract class AbstractApiClient {
   ...
   protected Client getClient() {
      return ClientBuilder
            .newClient(new ClientConfig(JacksonJsonProvider.class));
   }
   ...
   protected <E> E readEntity(final Response pResponse,
         final Class<E> pEntityClass) throws AppException {
      try {
   ...
   protected void checkResponseStatus(final Response pResponse)
         throws AppException {
      if (pResponse != null) {
   ...
   protected void badRequestStatus(final Response pResponse)
         throws ValidationException, AppException {
      ...
      if (errorResponse.containsKey(strError)) {
         throw new ValidationException((List<String>) errorResponse
               .get(strError));
      }
   }
}

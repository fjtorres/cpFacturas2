...
public class CustomerServiceImplTest {
    ...
    public void beforeMethod() {
        ...
        testInstance = new CustomerServiceImpl(mockDozerService, mockPersistenceService,
    ...
    public void addInvalidDto() throws ValidationException {
        ...
        Mockito.when(mockDozerService.convert(dto, Customer.class)).thenReturn(entity);
